    ...
    return (
        ...
        >
          <Grid container item xs={6} columns={2}>
            <Grid item xs={1} sx={{display: "flex", alignItems: 'center', padding: 1, backgroundColor: "#146E72",}}>
                <Typography sx={{padding: 1, maxHeight: "fit-content"}}>
                  test
                </Typography>
            </Grid>
            <Grid item xs={1}
              sx={{padding: 1, backgroundColor: "#2e4f4f", display: "flex", alignItems: 'center'}}>
                <Typography sx={{padding: 1, maxHeight: "fit-content"}}>
                    help me</Typography>
            </Grid>
          </Grid>
...
const TermsDrawer = () => {
  ...
  const terms = ['Inbox', 'Starred', 'Send email', 'Drafts', "dragst", 'Inbox', 'Starred', 'Send email', 'Drafts', "dragst", 'Inbox', 'Starred', 'Send email', 'Drafts', "dragst"];


    return (
        <Box sx={{ display: 'flex' }}>
        <Toolbar color="inherit" position="fixed" variant="dense" open={open} sx={{ flexGrow: 1 }}>
        ...
        >
          <DrawerHeader>
            <Grid container>
              ...
              {theme.direction === 'rtl' ? <ChevronLeftRoundedIcon /> : <ChevronRightRoundedIcon />}
                ...
                <Grid item sx={{color: "#FFFFFF", display: "flex", justifyContent: "flex-end", alignItems: 'center',  }}>
                <Box>
          ...
          <Divider />
            <Typography sx={{color: "#CBE4DE", display: "flex", alignItems: 'center', mx: 2, mt: 1 }}> Terms </Typography>
